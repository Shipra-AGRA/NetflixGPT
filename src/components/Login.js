        ...
        <div>
            ...
            <div className="absolute w-full h-full overflow-hidden">
                <img src="https://assets.nflxext.com/ffe/siteui/vlv3/a92a67ee-cd07-46a8-8354-c431a96a97b0/web/IN-en-20251103-TRIFECTA-perspective_8a65e995-9926-414c-83c5-f7cc9af10871_large.jpg"
                    alt="logo" className="h-screen object-cover md:object-contain md:h-auto md:overflow-y-hidden"/>
            </div>
            <form onSubmit={(e) => { e.preventDefault() }} className="absolute bg-black/85 md:w-3/12 w-full my-36 mx-auto right-0 left-0 p-12 bg-opacity-50">
